ActiveAdmin.register Post do
  ...
  controller do
    ...
    def create
      ...
      private
    def post_params
      params.require(:post).permit(:slug, :title, :text, :stext, :tags, :image, images_attributes: [:id, :image, :_destroy], post_categories_attributes: [:id, :title, :_destroy], seo_attributes: [:id, :meta_title, :meta_description, :meta_keywords, :_destroy])
    end
  end

  permit_params :slug, :title, :text, :stext, :tags, :image, images_attributes: [:id, :image, :_destroy], post_categories_attributes: [:id, :title, :_destroy], seo_attributes: [:id, :meta_title, :meta_description, :meta_keywords, :_destroy]
